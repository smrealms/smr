...
CREATE INDEX `GASC_GAME_RESEARCH_SHIP_CERTIFICATE_IDX` ON `game_alliance_certificate` (`game_research_certificate_id` ASC);
...
CREATE INDEX `GARP_GAME_RESEARCH_SHIP_CERTIFICATE_IDX` ON `game_alliance_research_progress` (`game_research_certificate_id` ASC);
