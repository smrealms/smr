...
docker compose exec -T mysql sh -c 'mysql -e "use smr_live; REPLACE INTO account_has_permission (account_id, permission_id) VALUES (1, 1); UPDATE account SET validated=\"TRUE\" WHERE account_id=1;"'
