...
function ctcp_version($fp, $rdata)
{
    ...
    if (preg_match('/^:(.*)!(.*)@(.*)\sPRIVMSG\s(.*)\s:.VERSION.\s$/i', $rdata, $msg)) {
...
function ctcp_finger($fp, $rdata)
{
    ...
    if (preg_match('/^:(.*)!(.*)@(.*)\sPRIVMSG\s(.*)\s:.FINGER.\s$/i', $rdata, $msg)) {
...
function ctcp_time($fp, $rdata)
{
    ...
    if (preg_match('/^:(.*)!(.*)@(.*)\sPRIVMSG\s(.*)\s:.TIME.\s$/i', $rdata, $msg)) {
...
function ctcp_ping($fp, $rdata)
{
    ...
    if (preg_match('/^:(.*)!(.*)@(.*)\sPRIVMSG\s(.*)\s:.PING\s(.*).\s$/i', $rdata, $msg)) {
