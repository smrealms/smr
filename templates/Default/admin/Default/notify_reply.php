...
<form name="NotifyReplyForm" method="POST" action="<?php echo $NotifyReplyFormHref; ?>">
	...
	<textarea spellcheck="true" name="offenderReply" id="InputFields"><?php if(isset($PreviewOffender)) { echo $PreviewOffender; } ?></textarea><br /><br />
	...
	<textarea spellcheck="true" name="offendedReply" id="InputFields"><?php if(isset($PreviewOffended)) { echo $PreviewOffended; } ?></textarea><br /><br />
