...
$db->query('INSERT INTO combat_logs VALUES("",' . $session->game_id . ',"PORT",' . $player->sector_id . ',' . time() . ',' . $session->account_id . ',' . $player->alliance_id . ',0,0,"' . mysql_real_escape_string(gzcompress($finalResults)) . '", "FALSE")');
