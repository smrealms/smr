...
$db->query("REPLACE INTO galactic_post_applications (game_id, account_id, description, written_before, articles_per_day) VALUES ($session->game_id, $player->account_id, " . format_string("$message", true) . " , '$value', $amount)");
$container = array();
