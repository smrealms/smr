...
$db->query('INSERT INTO combat_logs VALUES("",' . $session->game_id . ',"PLAYER",' . $player->sector_id . ',' . $sec . ',' . $session->account_id . ',' . $player->alliance_id . ',' . $var['target'] . ',' . $defender_alliance_id . ',"' . mysql_real_escape_string(gzcompress($results)) . '")');
