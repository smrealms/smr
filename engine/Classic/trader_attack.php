...
$db->query('INSERT INTO combat_logs VALUES("",' . SmrSession::$game_id . ',"PLAYER",' . $player->sector_id . ',' . $sec . ',' . SmrSession::$account_id . ',' . $player->alliance_id . ',' . $var['target'] . ',' . $defender_alliance_id . ',"' . mysql_real_escape_string(gzcompress($results)) . '")');
