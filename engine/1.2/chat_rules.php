...
//print("<div align=center><br><br><br>VJ Has temporarly taken down the applet.  Please visit <a href=\"http://www.vjtd3.com/irc\"><b>VJTD3's chat page</b></a> for a link to many applets.</div>");
//include("http://irc.VJTD3.com/index.shtml?" . strtr($player->player_name, array(" " => "+")));
?>
...
print("
<center><form method=\"POST\" action=\"http://chat.vjtd3.com/sjc.php?Nickname=" . urlencode(strtr($player->player_name, array(" " => "_"))) . "&Channel=%23smr\" name=\"loginform\" onsubmit=\"setjs();return true;\" id=\"ietest\" target=\"_chat\">");

print("<input type=\"hidden\" name=\"interface\" value=\"nonjs\">");
//print("<input type=\"hidden\" name=\"Nickname\" value=\"" . strtr($player->player_name, array(" " => "_")) . "\">");
