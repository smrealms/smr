...
//HoF
if ($hardware_id == 4) $player->increaseHOF($amount,array('Forces','Bought','Combat Drones'));
if ($hardware_id == 5) $player->increaseHOF($amount,array('Forces','Bought','Scout Drones'));
