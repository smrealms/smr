...
if ($var['ShipName']) $message .= '<br />If your ship is found to use HTML inappropriately you may be banned.  If your ship does contain inappropriate HTML talk to an admin ASAP.';
$message .= '</div>';
$container=create_container('skeleton.php','current_sector.php');
