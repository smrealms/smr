...
$PHP_OUTPUT.=('<td align="center"><input type="text" name="drop_mines" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('<td align="center"><input type="text" name="take_mines" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('</tr>');
...
$PHP_OUTPUT.=('<td align="center"><input type="text" name="drop_combat_drones" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('<td align="center"><input type="text" name="take_combat_drones" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('</tr>');
...
$PHP_OUTPUT.=('<td align="center"><input type="text" name="drop_scout_drones" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('<td align="center"><input type="text" name="take_scout_drones" value="0" id="InputFields" style="width:100px;text-align:center;"></td>');
$PHP_OUTPUT.=('</tr>');
