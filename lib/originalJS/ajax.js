...
function updateRefreshComp() 
{
	...
	{
		var xmlDoc=xmlHttpRefresh.responseXML,content,i;
		...
		{
			content='';
			for(i=0;i<xmlDoc.getElementsByTagName("htmlcontent")[0].childNodes.length;i++)
		...
		{
			content='';
			for(i=0;i<xmlDoc.getElementsByTagName("rightpanelhtml")[0].childNodes.length;i++)
