...
var currentlyFlashing=false, flashColour, origColour=document.style.backgroundColor, intervalFlash;
function TriggerAttackBlink(colour)
{
	...
	if (currentlyFlashing == false)
	{
		...
		//flash 3 times
		intervalFlash = setInterval('bgFlash()',1000);
		setTimeout('stopFlash()',5100);
	}
}
...
function bgFlash()
{
	if(document.style.backgroundColor==origColour)
		document.style.backgroundColor=flashColour;
	else
		document.style.backgroundColor==origColour
}