...
<table class="standard">
	...
	<tr>
		<td>Generator</td>
		<td align="center"><?php echo $ThisPlanet->getBuilding(1); ?></td>
		<td align="center"><?php echo $ThisPlanet->getMaxBuildings(1); ?></td>
	</tr>
	<tr>
		<td>Hangar</td>
		<td align="center"><?php echo $ThisPlanet->getBuilding(2); ?></td>
		<td align="center"><?php echo $ThisPlanet->getMaxBuildings(2); ?></td>
	</tr>
	<tr>
		<td>Turret</td>
		<td align="center"><?php echo $ThisPlanet->getBuilding(3); ?></td>
		<td align="center"><?php echo $ThisPlanet->getMaxBuildings(3); ?></td>
	</tr>
</table>
<br />
<table class="standard">
	...
	<tr>
		<td>Turrets</td>
		<td align="center"><?php echo $ThisPlanet->getBuilding(3) ?> / <?php echo $ThisPlanet->getMaxBuildings(3); ?></td>
...
if(isset($PlanetPlayers))
{
	foreach($PlanetPlayers as $PlanetPlayer)
	{
		...
		<a href="<?php echo $PlanetPlayer['SearchLink']; ?>"><span style="color:yellow;"><?php echo $PlanetPlayer['Player']->getPlayerName(); ?></span></a>&nbsp;<?php
		if(isset($PlanetPlayer['KickFormLink']))
		{
