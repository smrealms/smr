...
<form name="VoteForm" method="POST" action="<?php echo $VoteFormHREF; ?>">
	Question: <input name="question" type="text" class="InputFields" value="<?php if(isset($PreviewVote)) { echo $PreviewVote; } ?>" /><br />
	Days to end: <input name="days" type="text" class="InputFields" value="<?php if(isset($Days)) { echo $Days; } ?>" /><br />
	...
	Option: <input name="option" type="text" class="InputFields" value="<?php if(isset($PreviewOption)) { echo $PreviewOption; } ?>" /><br />
