...
<b>Please Note:</b> Your entry needs to be approved by an admin before going online</p>
...
<form name="AlbumEditForm" enctype="multipart/form-data" method="POST" action="<?php echo $AlbumEditHref; ?>">
	<table>
		<tr>
			<td align="right" style="font-weight:bold;">Nick:</td>
			<td><?php echo $ThisAccount->getHofName(); ?></td>
		</tr>
		
		<tr>
			<td align="right" style="font-weight:bold;">Location:</td>
			<td><input type="text" name="location" id="InputFields" value="<?php if(isset($AlbumEntry)){ echo $AlbumEntry['Location']; } else { ?>N/A<?php } ?>" onFocus="javascript:if (this.value == 'N/A') {this.value = '';}" onBlur="javascript:if (this.value == '') {this.value = 'N/A';}"></td>
		</tr>
		
		<tr>
			<td align="right" style="font-weight:bold;">Email Address:</td>
			<td><input type="text" name="email" id="InputFields" value="<?php if(isset($AlbumEntry)){ echo $AlbumEntry['Email']; } else { ?>N/A<?php } ?>" style="width:303px;" onFocus="javascript:if (this.value == 'N/A') {this.value = '';}" onBlur="javascript:if (this.value == '') {this.value = 'N/A';}"></td>
		</tr>
		
		<tr>
			<td align="right" style="font-weight:bold;">Website:</td>
			<td><input type="text" name="website" id="InputFields" style="width:303px;" value="<?php if(isset($AlbumEntry) && $AlbumEntry['Website'] != ''){ echo $AlbumEntry['Website']; } else { ?>http://<?php } ?>" onBlur="javascript:if (this.value == '') {this.value = 'http://';}"></td>
		</tr>
		
		<tr>
			<td align="right" style="font-weight:bold;">Birthdate:</td>
		...
		<tr>
			<td align="right" valign="top" style="font-weight:bold;">Other Info:<br /><small>(AIM/ICQ)</small></td>
		...
		<tr>
			<td align="right" valign="top" style="font-weight:bold;">Image:</td>
			<td>
