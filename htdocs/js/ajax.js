...
!function(){"use strict"
var t,n,e,i,o,a,c,l,r,f=!0,u=!0,s=!1
t=function(t,n){return function(){return t.call(this,n)}},window.onfocus=function(){s||(f=!0,clearTimeout(n),c())},window.onblur=function(){f=!1},window.onunload=l=function(){clearTimeout(n),s=!0,f=!1,null!==i&&i.abort()},r=function(t){var n,e=!1,i=location.href
...
0!==i.length&&(u=!0,f===!0&&(clearTimeout(n),n=setTimeout(c,e)))},c=function(){f===!0&&u===!0&&(u=!1,i=$.get("",{sn:o,ajax:1},a,"xml"))}
var h,g
...
var d=!1
window.followLink=function(t){return function(){d!==!0&&(d=!0,location.href=t,l())}},$(function(){$("a[href]:not([target])").click(function(t){1===t.which&&(d!==!0&&(d=!0,location.href=this.href,l()),t.preventDefault())})}),window.toggleWepD=function(t){$(".wep1:visible").slideToggle(600),$(".wep1:hidden").fadeToggle(600),$.get(t)}}()
