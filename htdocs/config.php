...
define('CREDITS_PER_GAL_MAP', 2);
define('CREDITS_PER_NAME_CHANGE', 2);
define('CREDITS_PER_TICKER', 1);
define('CREDITS_PER_TEXT_SHIP_NAME', 1);
define('CREDITS_PER_HTML_SHIP_NAME', 2);
define('CREDITS_PER_SHIP_LOGO', 3);
