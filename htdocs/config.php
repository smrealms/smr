...
define('ACCOUNT_ID_FED_CLERK', 65529);
define('ACCOUNT_ID_OP_ANNOUNCE', 65528);
define('ACCOUNT_ID_ALLIANCE_COMMAND', 65527);
...
define('BUYER_RESTRICTION_PORT', 4);
define('BUYER_RESTRICTION_PLANET', 5);
...
define('DEFEND_PORT_BOUNTY_PER_LEVEL',1000000);
