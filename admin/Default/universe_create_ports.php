...
foreach ($galaxies as $galaxy_id => $galaxy_name)
	$PHP_OUTPUT.=('<td align="center"><input type="input" name="ports['.$galaxy_id.']" size="3" id="InputFields" value="0" onKeyUp="sum_onkeyup('.$count.')" style="text-align:center;"></td>');
$PHP_OUTPUT.=('</tr>');
...
for ($level = 1; $level < 10; $level++) {
	...
	foreach ($galaxies as $galaxy_id => $galaxy_name) {
		$count++;
		$PHP_OUTPUT.=('<td align="center"><input type="input" name="input['.$galaxy_id.']['.$level.']" size="3" id="InputFields" value="'.$value.'" onKeyUp="sum_onkeyup('.$count.')" style="text-align:center;"></td>');
	}
	$PHP_OUTPUT.=('</tr>');
...
foreach ($galaxies as $galaxy_id => $galaxy_name)
	$PHP_OUTPUT.=('<td align="center"><input type="input" name="sum_'.$galaxy_id.'" size="3" id="InputFields" value="0" style="text-align:center;"></td>');
$PHP_OUTPUT.=('</tr>');
