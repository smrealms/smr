...
$db->query('REPLACE INTO alliance (alliance_id, game_id, alliance_name, alliance_description, alliance_password, leader_id, `mod`) VALUES ' .
			'(302,'.$game_id.',\'Newbie Help Alliance\',\'Newbie Help Alliance\',\'*\',13,\'Alliance message board includes tips and FAQs.\')');
$withPerDay = -2;
$removeMember = TRUE;
$changePass = TRUE;
$changeMOD = TRUE;
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 1, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 2, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 3, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 4, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 5, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 6, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 7, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 10, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 11, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 12, 1, '.$db->escapeString($text).', 13, '.TIME.')');



	
$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$game_id.', 302, 13, \'Alignment\')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 13, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 14, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 15, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 16, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 17, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 18, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 19, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 20, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 21, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
- Defense. Ship defense is made up of shields, armor and combat drones. The higher the defense, the harder you are to kill so more is better.<br />
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 22, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 23, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$game_id.', 302, 24, 1, '.$db->escapeString($text).', 13, '.TIME.')');
