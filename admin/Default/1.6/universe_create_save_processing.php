...
//		create_error('Max turns must not be greater than 650.');
	...
	if(!is_numeric($_REQUEST['alliance_max_vets']))
...
function createGame($gameID)
{
	...
	$sendAllMsg = FALSE;
	$db->query('REPLACE INTO alliance_has_roles (alliance_id, game_id, role_id, role, with_per_day, remove_member, change_pass, change_mod, change_roles, planet_access, exempt_with, mb_messages, send_alliance_msg) ' .
				'VALUES ('.NHA_ID.', '.$gameID.', 2, \'New Member\', '.$withPerDay.', '.$db->escapeString($removeMember).', '.$db->escapeString($changePass).', '.$db->escapeString($changeMOD).', '.$db->escapeString($changeRoles).', '.$db->escapeString($planetAccess).', '.$db->escapeString($exemptWith).', '.$db->escapeString($mbMessages).', '.$db->escapeString($sendAllMsg).')');
	$db->query('REPLACE INTO player_has_alliance_role (game_id, account_id, role_id, alliance_id) VALUES ('.$gameID.', '.ACCOUNT_ID_NHL.', 1,'.NHA_ID.')');
	
	// NHA default topics
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 1, \'Read this first!\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 1, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 2, \'What the Newbie Help Alliance (NHA) can do for you\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 2, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 3, \'Turns\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 3, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 4, \'How to trade\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 4, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 5, \'Safe trading\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 5, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 6, \'Get a scanner\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 6, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 7, \'Logging off safely\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 7, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 8, \'Merchant\\\'s Guide to the Universe\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 8, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
		
// remove newbie gals
//	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 9, \'Racial galaxies\')');
...
//	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 9, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 10, \'Respect for other players\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 10, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
		
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 11, \'Talk to the players\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 11, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 12, \'The Webboard\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 12, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	
	
		
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 13, \'Alignment\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 13, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 14, \'Watching the news and CPL\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 14, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 15, \'IRC chat\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 15, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 16, \'Avoiding mines\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 16, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 17, \'Port raiding\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 17, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 18, \'Operations guide\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 18, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 19, \'Multiple accounts\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 19, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 20, \'Moving on to a new alliance\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 20, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
			
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 21, \'Experience\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 22, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 23, \'Weapons\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 23, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
	
	$db->query('REPLACE INTO alliance_thread_topic (game_id, alliance_id, thread_id, topic) VALUES ('.$gameID.', '.NHA_ID.', 24, \'Planets and Terrritory\')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', '.NHA_ID.', 24, 1, '.$db->escapeString($text).', '.ACCOUNT_ID_NHL.', '.TIME.')');
}
