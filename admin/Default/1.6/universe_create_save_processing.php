...
function createGame($gameID)
{
	...
	$db->query('REPLACE INTO alliance (alliance_id, game_id, alliance_name, alliance_description, alliance_password, leader_id, `mod`) VALUES ' .
				'(302,'.$gameID.',\'Newbie Help Alliance\',\'Newbie Help Alliance\',\'*\',13,\'Alliance message board includes tips and FAQs.\')');
	$withPerDay = -2;
	$removeMember = TRUE;
	$changePass = TRUE;
	$changeMOD = TRUE;
	...
	$db->query('REPLACE INTO player_has_alliance_role (game_id, account_id, role_id, alliance_id) VALUES ('.$gameID.', 13, 1,302)');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 1, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 2, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 3, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 4, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 5, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 6, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 7, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 8, 1, '.$db->escapeString($text).', 13, '.TIME.')');
...
//	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 9, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 10, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 11, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 12, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 13, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 14, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 15, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 16, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 17, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 18, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 19, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 20, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 21, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 22, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 23, 1, '.$db->escapeString($text).', 13, '.TIME.')');
	...
	$db->query('REPLACE INTO alliance_thread (game_id, alliance_id, thread_id, reply_id, text, sender_id, time) VALUES('.$gameID.', 302, 24, 1, '.$db->escapeString($text).', 13, '.TIME.')');
}
