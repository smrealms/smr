...
$PHP_OUTPUT.=('<input type="text" name="to_email" value="'.$account->email.'" id="InputFields" size="25">&nbsp;');
...
//if ($db->nextRecord()) {
	...
	// debug output
	$PHP_OUTPUT.=('.$db->escapeString($account_id. Preparing mail for $to_name <$to_email>... ');
