...
$db->query('OPTIMIZE TABLE `account` , `account_donated` , `account_exceptions` , `account_has_closing_history` , `account_has_credits` , `account_has_ip` , `account_has_logs` , `account_has_permission` , `account_has_points` , `account_has_stats` , `account_is_closed` , `active_session` , `album` , `album_has_comments` , `alliance` , `alliance_bank_transactions` , `alliance_has_roles` , `alliance_thread` , `alliance_thread_topic` , `announcement` , `anon_bank` , `anon_bank_transactions` , `bar_drink` , `bar_tender` , `bar_wall` , `beta_test` , `bounty` , `changelog` , `closing_reason` , `galactic_post_applications` , `galactic_post_article` , `galactic_post_paper` , `galactic_post_paper_content` , `galactic_post_writer` , `game` , `game_galaxy`, `game_disable` , `good` , `hardware_type` , `irc_seen` , `kills` , `level` , `location` , `location_is_bank` , `location_is_bar` , `location_is_fed` , `location_is_hq` , `location_is_ug` , `location_sells_hardware` , `location_sells_ships` , `location_sells_weapons` , `location_type` , `log_has_notes` , `log_type` , `manual` , `mb_exceptions` , `mb_keywords` , `message` , `message_notify` , `message_type` , `multi_checking_cookie` , `news` , `newsletter` , `notification` , `npc` , `npc_long_term_goal` , `npc_short_term_goal` , `permission` , `planet` , `planet_is_building` , `planet_construction` , `planet_cost_credits` , `planet_cost_good` , `planet_cost_time` , `planet_has_cargo` , `planet_has_building` , `player` , `player_has_alliance_role` , `player_has_drinks` , `player_has_relation` , `player_has_ticker` , `player_has_ticket` , `player_has_unread_messages` , `player_plotted_course` , `player_read_thread` , `player_visited_port` , `player_visited_sector` , `player_votes_pact` , `player_votes_relation` , `plot_cache` , `port` , `port_has_goods` , `profile` , `race` , `race_has_relation` , `race_has_voting` , `rankings` , `sector` , `sector_has_forces` , `ship_has_cargo` , `ship_has_hardware` , `ship_has_illusion` , `ship_has_name` , `ship_has_weapon` , `ship_is_cloaked` , `ship_type` , `ship_type_support_hardware` , `version` , `warp` , `weapon_type`');
