...
$db->query('OPTIMIZE TABLE
	...
	`changelog`,
	`closing_reason`,
	`galactic_post_applications`,
	`galactic_post_article`,
	`galactic_post_paper`,
	`galactic_post_paper_content`,
	...
	`location_is_hq`,
	`location_is_ug`,
	`location_sells_hardware`,
	`location_sells_ships`,
	`location_sells_weapons`,
	`location_type`,
	`log_has_notes`,
	`log_type`,
	`manual`,
	...
	`player_plotted_course`,
	`player_read_thread`,
	`player_visited_port`,
	`player_visited_sector`,
	`player_votes_pact`,
	`player_votes_relation`,
	`plot_cache`,
	`port`,
	`port_has_goods`,
	`profile`,
