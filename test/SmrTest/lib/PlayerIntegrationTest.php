...
class PlayerIntegrationTest extends BaseIntegrationSpec {
	...
	public function test_createPlayer(): void {
		...
		$player = Player::createPlayer($accountID, self::$gameID, $name, $raceID, $isNewbie, $isNpc);
	...
	public function test_createPlayer_reserved_name_by_self(): void {
		...
		$player = Player::createPlayer($account->getAccountID(), self::$gameID, $name, RACE_HUMAN, false);
	...
	public function test_createPlayer_increment_playerid(): void {
		Player::createPlayer(1, self::$gameID, 'test1', RACE_HUMAN, false);
		$player = Player::createPlayer(2, self::$gameID, 'test2', RACE_HUMAN, false);
	...
	public function test_changePlayerName_throws_when_name_unchanged(): void {
		...
		$name = 'test';
		$player = Player::createPlayer(1, self::$gameID, $name, RACE_HUMAN, false);
		$this->expectException(UserError::class);
	...
	public function test_changePlayerName_throws_when_name_is_in_use(): void {
		...
		$name1 = 'test1';
		Player::createPlayer(1, self::$gameID, $name1, RACE_HUMAN, false);
		$player2 = Player::createPlayer(2, self::$gameID, 'test2', RACE_HUMAN, false);
		$this->expectException(UserError::class);
	...
	public function test_changePlayerName(): void {
		...
		$player = Player::createPlayer(1, self::$gameID, 'test', RACE_HUMAN, false);
