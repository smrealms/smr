				...
				foreach ($Rows as $Row) { ?>
					<tr>
						...
						if ($Row['matches']) { ?>
							...
							<td><input type=text name="suspicion[<?php echo $Row['account_id']; ?>]" value="<?php echo $Row['suspicion']; ?>"></td><?php
						} else { ?>
							<td></td>
							<td><input type=checkbox name="disable_id[]" value="<?php echo $Row['account_id']; ?>"></td>
							<td><input type=text name="suspicion2[<?php echo $Row['account_id']; ?>]"></td><?php
						} ?>
