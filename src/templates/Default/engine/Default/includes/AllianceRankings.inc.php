<div class="center">
	...
	$this->includeTemplate('includes/AllianceRankingsList.inc.php', array('RankingStat' => $RankingStat, 'Rankings' => $Rankings)); ?>
	...
	<?php $this->includeTemplate('includes/AllianceRankingsList.inc.php', array('RankingStat' => $RankingStat, 'Rankings' => $FilteredRankings)); ?>
</div>
