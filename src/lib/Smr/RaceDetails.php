...
class RaceDetails {
	...
	private const array LONG_DESCRIPTION = [
		...
		RACE_IKTHORNE => 'Considering the average Ik\'Thorne stands about 11 feet tall, it is no surprise that they are the designers and builders of the largest cruisers that are availible throughout the galaxy. While there are several other models availible, the Ik\'Thorne line of battle cruisers and carriers are commonly regarded as the strongest of the ships. However, their weapons are not exceedingly strong, and they usually are forced to go to others to equip the ship with weapons. The Ik\'Thorne are a race of tall humanoids. They like stability. They don\'t care much if they are at war or peace with others, only that it is consistent. Races who are constantly changing their views annoy them. This is probably due to their extremely long lifespans. While they have butted heads with the Thevians and the Salvene over the centuries, they maintain no outstanding "enemies". However, because their empire is often attacked and plundered for its wealth and knowledge, they are drawn into many conflicts.',
