...
const ALIGNMENT_DEPUTY = 150;
const ALIGNMENT_SMUGGLER = -150;
...
const SHIP_TYPE_ADVANCED_COURIER_VESSEL = 8;
...
const SHIP_TYPE_SLAYER = 100;
const SHIP_TYPE_DEMONICA = 666;

/*
 * Weapon types
 */
const WEAPON_TYPE_NEWBIE_PULSE_LASER = 1;
const WEAPON_TYPE_HHG = 3;
...
const WEAPON_TYPE_HELL_BLASTER = 666;
 ...
 * Relations
 */
const MAX_POLITICAL_RELATIONS = 500;
const MIN_POLITICAL_RELATIONS = -500;
const MAX_PERSONAL_RELATIONS = 3000;
const MIN_PERSONAL_RELATIONS = -1000;
